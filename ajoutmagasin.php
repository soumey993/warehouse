  ...
  <main id="main" class="main">
    ...
    <section class="section">
      ...
      <div class="bg-transparent rounded h-100 p-4">
                        <h4> Enregistrement des Magasins</h4>
                    <hr>
            <form action="" method="post">
                <div class="form-group mb-3">
                    <label for="">Nom Magasin</label>
                    <input type="text" name="nom_magasin" class="form-control" placeholder="Entrez magasin" required> 

                </div>
                <div class="form-group mb-3">
                    <label for="">Adresse Magasin</label>
                    <input type="text" name="adresse_magasin" class="form-control" placeholder="Entrez adresse magasin" required> 
      ...
      if(isset($_POST['augmente']))
      {
          ...
          $query = "INSERT INTO magasin(nom_magasin, adresse_magasin) VALUES('$nomcommune', '$nbrehbt')";
...
?>
        ...
        <h6 class="mb-4 my-4">Mgasins déjà Enregistrés</h6>
        <table class="table table-bordered">
               <thead class="table-dark">
                ...
                <tbody>
                  <?php
                  $sql1 = "SELECT * FROM magasin where etat=1";
