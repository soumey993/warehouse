  ...
  <main id="main" class="main">
    ...
    <section class="section">
      ...
      <div class="bg-transparent rounded h-100 p-4">
                        <h4> Enregistrement des Produits</h4>
                    ...
                    if(isset($_POST['augmente']))
                    {
                        ...
                        $query = "INSERT INTO produit(nom_produit, prix_achat,prix_vente,quantite_stock,id_categorie)
                         VALUES('$nom_produit', $prix_achat,$prix_vente,$quantite_stock,$id_categorie)";
                ...
                ?>
                 ...
                 <div class="form-group mb-3">
                            ...
                            <input type="text" name="nom_produit" class="form-control" placeholder="Entrez nom produit " required> 

                       </div>

                       <div class="form-group mb-3">
                            <label for="">Prix d'achat</label>
                            <input type="float" name="prix_achat" class="form-control" placeholder="Entrez prix achat " required> 

                       </div>
                       <div class="form-group mb-3">
                            <label for="">Prix de vente</label>
                            <input type="float" name="prix_vente" class="form-control" placeholder="Entrez prix vente " required> 

                       </div>
                       <div class="form-group mb-3">
                            <label for="">Quantité en stock</label>
                            <input type="int" name="quantite_stock" class="form-control" placeholder="Entrez quantite en stock " required> 
                ...
                <a href="produit.php" class="btn btn-danger"> Annuler </a>
              </form>

        <div class="clearfix"></div>
        <h6 class="mb-4 my-4">Produits déjà Enregistrées</h6>
