...
<body>
  ...
  <?php
                  ...
                  $query= "SELECT * FROM magasin where id_magasin='$idcommune' ";
     ...
     <section class="section">
      ...
      <div class="bg-transparent rounded h-100 p-4">
                    ...
                    <h4>Modification des Magasins:</h4>
                  <hr>
                  <form action="" method="post">
                      <input type="hidden" name="id_magasin" value="<?php echo $row['id_magasin'] ?>">
                        <div class="form-group mb-3">
                            <label for="">Nom Magasin</label>
                            <input type="text" name="nom_magasin" class="form-control"  value="<?php echo $row['nom_magasin'] ?>" placeholder="Entrez nom magasin" required> 

                          </div>
                <div class="form-group mb-3">
                    <label for="">Adresse Magasin</label>
                    <input type="text" name="adresse_magasin" class="form-control" value="<?php echo $row['adresse_magasin'] ?>" placeholder="Entrez adresse magasin" required> 
            ...
            <?php
                 ...
                 {
                     $nomcommune = $_POST['nom_magasin'];
                     $nbrehbt = $_POST['adresse_magasin'];
                    

                     $query = "UPDATE magasin SET nom_magasin = '$nomcommune', adresse_magasin = '$nbrehbt' WHERE id_magasin= '$idcommune' ";
                     $query_run = mysqli_query($connection, $query);
